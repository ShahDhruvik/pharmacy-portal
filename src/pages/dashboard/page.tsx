    ...
    <Grid container component='main' sx={{ height: '100vh' }}>
      ...
      <Grid item xs={false} sm={4} md={7}>
        <div className={`flex items-center justify-start flex-1 flex-wrap gap-5 h-20`}>
          ...
          />
          <p className={` text-black font-semibold flex gap-2 ml-1 text-2xl`}>
        ...
        <div className='relative'>
          {isImageLoading.isLoading ? (
            <div
              className={`aspect-video w-[80%] bg-slate-300 animate-pulse flex items-center justify-center`}
            >
              loading
            </div>
          ...
          {isImageLoading.isLoading ? (
            <div
              className={`w-60 aspect-square shadow-cardShadow absolute top-1/4 right-16 bg-slate-300 animate-pulse flex items-center justify-center`}
            >
              loading
            </div>
          ) : isImageLoading.notFound ? (
        ...
        <div>
          {isFeatureLoading.isLoading ? (
            <div className='w-full h-60 flex items-center justify-center  my-5 animate-pulse bg-slate-50 '>
              loading features
            </div>
